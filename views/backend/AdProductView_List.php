        ...
        <?php foreach ($data['productList'] as $product): ?>
            <div class="item" data-id="<?php echo $product['masp']; ?>">
                ...
                <div class="button-group">
                    <a href="<?php echo BASE_URL . 'AdProduct/update/' . $product['masp']; ?>" class="edit">Sửa</a>
                    <a href="<?php echo BASE_URL . 'AdProduct/delete/' . $product['masp']; ?>" class="delete">Xóa</a>
                    <a href="<?php echo BASE_URL . 'AdProduct/viewDetail/' . $product['masp']; ?>" class="detail">Chi tiết</a>
                </div>
            </div>
        <?php endforeach; ?>
    <?php else: ?>
