...
<body>
        ...
        <table>
            ...
            <?php foreach ($data['users'] as $user) { ?>
                <tr>
                    ...
                    <td><img src="<?php echo BASE_URL . $user['avatar']; ?>" alt="Avatar" style="width: 50px; height: 50px; object-fit: cover;"></td>
                    <td><?php echo $user['phone']; ?></td>
                    <td><?php echo $user['role']; ?></td>
                    <td>
                        <div class="action-links">
                            <a href="<?php echo BASE_URL; ?>User/update/<?php echo $user['username']; ?>" style="color: green; margin-right: 10px; text-decoration: none;">Sửa</a>
                            <a href="<?php echo BASE_URL; ?>User/deleteUser/<?php echo $user['username']; ?>" style="color: red; text-decoration: none;">Xóa</a>
                        </div>
                    </td>
                </tr>
            <?php } ?>
    ...
    style="border: 2px solid tomato; padding: 10px 20px;
    border-radius: 10px; background-color: #fff;
    text-decoration: none; font-weight: bold;
    color: #333; display: block; text-align: center; width: 300px;">Thêm người dùng</a> -->
</body>
